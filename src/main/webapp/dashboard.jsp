...
<style>
    ...
    *, *::before, *::after {
    ...
    .tx-amount.deposit { color: var(--color-green); }
    .tx-amount.withdraw { color: var(--color-red); }
    ...
    @media (max-width: 768px) {
        ...
        .page-wrapper { padding: 28px 20px 56px; }
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Welcome back, <%= request.getAttribute("username") %></p>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value balance">&#8377;<%= request.getAttribute("balance") %></div>
            </div>
        ...
        <div class="actions-row">
            ...
            <a href="topup.jsp" class="action-btn action-btn-primary">
            ...
            <table>
                ...
                <tbody>
                    ...
                    for (Transaction tx : transactions) {
                        ...
                        String badgeClass = typeLower.contains("deposit") ? "deposit"
                                          : typeLower.contains("withdraw") ? "withdraw"
                                          : "default";
                    %>
                    <tr>

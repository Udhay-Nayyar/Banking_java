...
<style>
    ...
    *, *::before, *::after {
    ...
    .input-group input.has-icon    { padding-right: 36px; }
    ...
    .notice.amber svg { stroke: var(--color-amber); }
    .notice.amber p   { color: #92400e; }
        ...
        <div class="page-grid">
                ...
                <div class="card-inner">
                    ...
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <p class="card-subtitle">Send money securely to another account</p>
                        </div>
                    </div>
                    ...
                    <form action="transfer" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <p class="input-hint">Double-check the account number before confirming.</p>
                        </div>
                        ...
                        <div class="input-group">
                            <div class="label-row">
                                ...
                                <span class="label-hint">Max &#8377;<%= request.getAttribute("balance") %></span>
                            </div>
                            <div class="input-wrapper">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    required
                                    oninput="updateBalanceAfter(this.value)"
                                >
                            </div>
                        ...
                        <div class="input-group">
                            <label for="note">Note <span style="color:var(--color-text-muted); font-weight:400;">(optional)</span></label>
                            <textarea
                                id="note"
                                name="note"
                                placeholder="e.g. Rent for May, Shared dinner, etc."
                            ></textarea>
                        </div>
                        ...
                        <div class="notice amber" style="margin-top: 4px;">
                            ...
                            <p>Transfers are processed immediately and cannot be reversed. Verify the recipient account number carefully.</p>
                        </div>
            ...
            <div class="side-panel">
                ...
                <div class="side-card">
                    ...
                    <p class="balance-display">&#8377;<%= request.getAttribute("balance") %></p>
                    <p class="balance-sub">Current account balance</p>

                    <div class="balance-divider"></div>

                    <div class="balance-after-row">
                        <span class="balance-after-label">Balance after transfer</span>
                        <span class="balance-after-value" id="balance-after">&#8377;<%= request.getAttribute("balance") %></span>
                    </div>
                </div>
                ...
                <div class="side-card">
                    ...
                    <div class="tips-list">
                        <div class="tip-item">
                            ...
                            <p class="tip-text">Always verify the recipient's account number before submitting.</p>
                        </div>
                        <div class="tip-item">
                            <div class="tip-dot"></div>
                            <p class="tip-text">Transfers are instant and cannot be reversed once confirmed.</p>
                        </div>
                        <div class="tip-item">
                            <div class="tip-dot"></div>
                            <p class="tip-text">You cannot transfer more than your available balance.</p>
                        </div>
                        <div class="tip-item">
                            <div class="tip-dot"></div>
                            <p class="tip-text">Contact support immediately if you make an incorrect transfer.</p>
                        </div>
                    </div>
                </div>
